...
laserSourceCoherenceLength = (2 * log(2)) / pi * laserSourceWavelength^2 / (brainRefractiveIndex * laserSourceFWHM); % https://doi.org/10.1364/AO.41.005256

% convert fractional units to decimal for readability
laserSourceCoherenceLength = vpa(laserSourceCoherenceLength)