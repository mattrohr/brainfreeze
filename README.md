...
- induced motor motion: as long as the motor doesn't induce more motion than the motion we're correcting for. Thorlabs stuff seems quite good (insert measurement). But note that Boas said even 1 [μm] is a lot for OCT. inertia of stage
