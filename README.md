...
8. Attach IMU sensor Scotch double-sided adhesive square. The sensor has an orientation compass on the bottom right. Position the compass so it faces up, X points to the right ear, Y points to the snout, and the sensor is close to the cranial window. Ideally this area should be shaven for a more secure fit.
